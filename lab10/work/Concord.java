...
public class Concord {
   ...
   public void printSorted(PrintStream out) {
      //Iterator<Map.Entry<String, Integer>> iterator = concord.entrySet().iterator();
      ArrayList<Map.Entry<String, Integer>> concordArrayList = new ArrayList<>();
      for (Map.Entry<String, Integer> curr : concord.entrySet()) {
         concordArrayList.add(curr);
      }
      //ArrayList<Map.Entry<String, Integer>> concordArrayList1 = new ArrayList<>(concord.entrySet());
      concordArrayList.sort(new ConcordComparator());
      for (Map.Entry<String, Integer> curr : concordArrayList) {
         out.println(curr.getKey() + " " + curr.getValue());
      }
   }
